...
def run_ecephys(npx_directory,results_directory):
    ...
    ni_present = True
    ni_extract_string = '-XD=1,0,0 -XD=0,0,0' # '-XA=0,1,3,500 -iXA=1,3,3,0  -XD=-1,1,50 -XD=-1,2,1.7 -XD=-1,3,5 -iXD=-1,3,5'
    ...
    toStream_sync_params = '-SY=0,384,6,0' # 'XD=0,1,3,500'  
    niStream_sync_params = '-XD=1,0,0 -XD=0,0,0 -XD=0,0,0' # 'XA=0,1,3,500'   # copy from ni_extract_string, set to None if no Aux data, no spaces
    ...
    for spec in run_specs:
        ...
        for i, prb in enumerate(prb_list):
            ...
            sync_extract = '-SY=' + prb + ',-1,6,0' # ',-1,6,500' NOTE CHANGE HERE FOR VARIABLE PULSE LENGTH!!!
