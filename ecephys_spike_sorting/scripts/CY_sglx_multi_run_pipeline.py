...
ksTh_dict = {'default':'[10,4]', 'cortex':'[10,4]', 'medulla':'[10,4]', 'thalamus':'[10,4]'} # CY 8/20/2023 tried [8,4]. Was all [10,4]
...
logName = 'output_log.csv'

# Raw data directory = npx_directory
# run_specs = name, gate, trigger and probes to process
npx_directory = r'\\research.files.med.Harvard.edu\neurobio\HarveyLab\Tier1\Cindy\EphysData\CY\40\230625\155150' # r'C:\Users\xinto\Desktop' #r'\\research.files.med.Harvard.edu\neurobio\HarveyLab\Tier1\Cindy\EphysData' 
...
run_specs = [									
						['CY40_LLP_20230625', '0', 'start,end', '0', ['thalamus'] ]
]
...
ni_present = True
# ni_extract_string = '-XD=-1,0,500 -XD=-1,1,0 -iXD=-1,1,0 -XA=3,2,0,0' #'-XA=0,1,3,500 -iXA=1,3,3,0  -XD=-1,1,50 -XD=-1,2,1.7 -XD=-1,3,5 -iXD=-1,3,5'
...
event_ex_param_str = '-XD=-1,0,500 -XD=-1,1,0 -iXD=-1,1,0 -XA=3,2,0,0'
...
niStream_sync_params = 'XD=-1,0,500'   # copy from ni_extract_string, set to None if no Aux data, no spaces
